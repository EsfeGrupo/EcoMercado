...
public interface ITarjetaCreditoRepository extends JpaRepository<TarjetaCredito, Integer> {
    Page<TarjetaCredito> findByNumeroContainingIgnoreCaseAndNombreTitularContainingIgnoreCaseAndBancoContainingIgnoreCase(String numero, String nombreTitular, String banco, Pageable pageable);
